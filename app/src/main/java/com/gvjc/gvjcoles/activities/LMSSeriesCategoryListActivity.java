...
import com.gvjc.gvjcoles.adapters.LMSSeriesCategoryListAdapter;
                        ...
                        try {
                            ...
                            if(status==1){
                                ...
                                if(lmsSeriesCategoryLists.size()!=0){
                                    adapter = new LMSSeriesCategoryListAdapter(LMSSeriesCategoryListActivity.this,lmsSeriesCategoryLists);
