...
public class KeyParagrapAdapter extends RecyclerView.Adapter<KeyParagrapAdapter.ViewHolder> {
    ...
    public KeyParagrapAdapter(Context context, List<Paragraph> parentList, List<String> correctAnsList, List<String> userAnsList) {
    ...
    @Override
    public KeyParagrapAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_paragraph, parent, false);
        return new ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(KeyParagrapAdapter.ViewHolder holder, final int position) {
