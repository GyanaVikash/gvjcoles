...
public class KeyVideoAdapter extends RecyclerView.Adapter<KeyVideoAdapter.ViewHolder> {
    ...
    int childPosition ;
    public KeyVideoAdapter(Context context, List<Paragraph> parentList, List<String> correctAnsList, List<String> userAnsList){
